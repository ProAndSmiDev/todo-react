        ...
        return (
            <section className={`todo-task-form mt-5 ${this.props.cName}`}>
                ...
                <div className="form-group p-3 d-flex flex-column todo-form todo-task-form__form">
                    <input type="text" placeholder={'Введите название задачи'} className={'form-control todo-form__input'} value={this.props.taskName} onChange={this.props.updateTaskName}/>
                    ...
                    <ToDoButton
                        ...
                        btnText={'Add task'}
                        btnEvent={() => this.props.addTask(this.props.taskName)}/>
                </div>
            </section>
        );
    }
